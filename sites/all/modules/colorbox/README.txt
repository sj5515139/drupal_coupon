...
example styles included in the Colorbox JS library download.
...
your folder name:
 i.e. "colorbox_mycolorbox.css" and "colorbox_mycolorbox.js"

Add entries in your theme's .info file for 
the Colorbox CSS/JS files:
...
What ever content you want to display in a Colorbox.</div>
</div>
...
It is possible to add another path as an option to the command,
 but not
